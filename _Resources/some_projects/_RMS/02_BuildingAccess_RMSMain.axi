...
PROGRAM_NAME='02_BuildingAccess_RMSMain'
...
// dvDOOR01
VOLATILE SLONG      slRMSSecurityForcedOpen  // Forced Open
...
DEFINE_FUNCTION RMSDevMonRegisterCallback()
{
  ...
  RMSNetLinxDeviceOnline(dvTP1a,'NXD-1200VG')

  RMSRegisterDevice(dvDOOR01,'Security','Briva','ACS5000')
  RMSRegisterDeviceNumberParam(dvDOOR01,'Forced Open',
      0,RMS_COMP_NONE,RMS_STAT_NOT_ASSIGNED,
      FALSE,0,
      RMS_PARAM_SET,slRMSSecurityForcedOpen,0,0)
}
...
(**************************************************************)
(* Call Name: RMSSetSecurityForcedOpen                        *)
(* Function:  Set Forced Open                                 *)
(* Param:     Value                                           *)
(* Return:    None                                            *)
(**************************************************************)
DEFINE_FUNCTION RMSSetSecurityForcedOpen(SLONG slValue)
LOCAL_VAR
CHAR bInit
{
  IF (slRMSSecurityForcedOpen <> slValue || bInit = FALSE)
    RMSChangeNumberParam(dvDOOR01,'Forced Open',RMS_PARAM_SET,slValue)
  slRMSSecurityForcedOpen = slValue
  bInit = TRUE
}
...
DATA_EVENT[vdvRMSEngine]
{
  ONLINE:
  {
    ...
    // Security
    RMSSetDeviceInfo(dvDOOR01,'Security','Briva','ACS5000')
  }
}
...
DATA_EVENT [dvDOOR01]
{
  ...
  OFFLINE:
    RMSNetLinxDeviceOffline(dvDOOR01)
}
...
DATA_EVENT[vdvCLActions]
{
  ...
  {
    // Set Room Info
    SEND_COMMAND DATA.DEVICE,'SET ROOM INFO-02_BuildingAccess,Kiosk,AMX'
