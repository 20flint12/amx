...
CHAR __RMS_DEV_MON_VERSION__[]   = '3.3.33'
...
//
DEFINE_FUNCTION CHAR[RMS_DUET_MAX_HDR_LEN] RMSDuetParseCmdHeader(CHAR cCmd[])
{
  STACK_VAR CHAR cTemp[RMS_DUET_MAX_HDR_LEN]
  ...
  IF (dvDPS.Number)
  {
    ...
    SWITCH (sDevInfo.DEVICE_ID)
    {
	  ...
	  ACTIVE(sDevInfo.DEVICE_ID_STRING = 'NI-3000' ||
	         ...
	         sDevInfo.DEVICE_ID_STRING = 'NI-3101' ||
