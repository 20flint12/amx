MODULE_NAME='Yamaha DME24 UI'(DEV dvComms[], DEV dvPanel)
(***********************************************************)
(* System Type : NetLinx                                   *)
(***********************************************************)
		...
		SWITCH(GET_LAST(nButtonMic) - 1)
		{
			CASE 0:
			{
				IF (cMicAllEnabled)
				{
					...
					IF ([dvComms[132], 199] && [dvComms[133], 199] && [dvComms[134], 199] && [dvComms[135], 199])
					{
		...
		SWITCH (GET_LAST(nButtonRoom) - 1)
		{
			CASE 0:
			{
				IF (cRoomAllEnabled)
				{
					...
					IF ([dvComms[76], 199] && [dvComms[137], 199] && [dvComms[139], 199] && [dvComms[141], 199])
					{
						PULSE[dvComms[76], 28]
						PULSE[dvComms[87], 28]
