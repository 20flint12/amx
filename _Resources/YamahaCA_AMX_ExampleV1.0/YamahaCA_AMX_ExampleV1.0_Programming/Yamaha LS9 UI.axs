MODULE_NAME='Yamaha LS9 UI'(DEV dvComms, DEV dvPanel)
(***********************************************************)
(* System Type : NetLinx                                   *)
(***********************************************************)
...
DEFINE_FUNCTION GetAllValues()
{
	...
	SEND_COMMAND dvComms,'GETINPUTFADER-65'
	SEND_COMMAND dvComms,'GETINPUTFADER-67'
	...
	SEND_COMMAND dvComms,'GETINPUTENABLE-65'
	SEND_COMMAND dvComms,'GETINPUTENABLE-67'
...
DEFINE_FUNCTION Poll()
{
	IF (cPollOn && cEnabled)
	{
		...
		SEND_COMMAND dvComms,'GETINPUTMETER-65,4'
...
BUTTON_EVENT[dvPanel, nButtonInputStereo1On]
{
	PUSH:
	{
		SEND_COMMAND dvComms,"'SETINPUTENABLE-65,',ITOA(!cInputStereoOn[1])"
	}
}
...
BUTTON_EVENT[dvPanel, nButtonInputStereo2On]
{
	PUSH:
	{
		SEND_COMMAND dvComms,"'SETINPUTENABLE-67,',ITOA(!cInputStereoOn[2])"
	}
}
...
BUTTON_EVENT[dvPanel, nButtonInputStereo1Up]
{
	PUSH:
	{
		...
		{
			SEND_COMMAND dvComms,"'SETINPUTFADER-65,',ITOA(nInputStereoFader[1] + nFaderStep)"
		}
		ELSE
		{
			SEND_COMMAND dvComms,"'SETINPUTFADER-65,1023'"
		}
	}
	HOLD[nFaderRepeatTime,REPEAT]:
	{
...
BUTTON_EVENT[dvPanel, nButtonInputStereo2Up]
{
	PUSH:
	{
		...
		{
			SEND_COMMAND dvComms,"'SETINPUTFADER-67,',ITOA(nInputStereoFader[2] + nFaderStep)"
		}
		ELSE
		{
			SEND_COMMAND dvComms,"'SETINPUTFADER-67,1023'"
		}
	}
	HOLD[nFaderRepeatTime,REPEAT]:
	{
...
BUTTON_EVENT[dvPanel, nButtonInputStereo1Down]
{
	PUSH:
	{
		...
		ELSE
		{
			SEND_COMMAND dvComms,"'SETINPUTFADER-65,0'"
		}
	}
	HOLD[nFaderRepeatTime,REPEAT]:
	{
...
BUTTON_EVENT[dvPanel, nButtonInputStereo2Down]
{
	PUSH:
	{
		...
		ELSE
		{
			SEND_COMMAND dvComms,"'SETINPUTFADER-67,0'"
		}
	}
	HOLD[nFaderRepeatTime,REPEAT]:
	{
